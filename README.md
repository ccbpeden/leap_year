...
&nbsp;
## Description
An App that determines whether a given year is a leap year
...
* Go to my [Github repository] (https://github.com/ccbpeden/leap_year)
* Download the zip file via the green button
* Unzip the file and open the **leap_year** folder
* Open Terminal, navigate to **leap_year** project folder, type **_composer install_** and hit enter
* Navigate Terminal to the **leap_year/web** folder and set up a server by typing **_php -S localhost:8000_**
